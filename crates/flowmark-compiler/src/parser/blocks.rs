...
fn is_valid_binding_identifier(value: &str) -> bool {
    ...
    const RESERVED: &[&str] = &[
        "await", "break", "case", "catch", "class", "const", "continue", "context", "debugger",
        "default", "delete", "do", "else", "enum", "export", "extends", "false", "finally",
        "for", "function", "if", "import", "in", "instanceof", "let", "new", "null", "output",
        "renderValue", "return", "static", "super", "switch", "this", "throw", "true", "try",
